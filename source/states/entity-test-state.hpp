...
class EntityTestState : public our::State
{
    ...
    void onDraw(double deltaTime) override
    {
        ...
        //  The VP matrix is the product of the camera's projection and view matrices.
        ...
        for (auto &entity : world.getEntities())
        {
            ...
            // Set the shader program to use for this entity.
