...
class Menustate: public our::State {
    ...
    void onInitialize() override {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/menu.png");
        ...
        buttons[0].position = {671.0f, 960.0f};
        buttons[0].size = {550.0f, 33.0f};
        buttons[0].action = [this](){this->getApp()->changeState("play");};

        buttons[1].position = {690.0f, 1010.0f};
        buttons[1].size = {500.0f, 33.0f};
