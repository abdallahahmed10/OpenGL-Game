...
namespace our
{
    ...
    public:
        ...
        Entity *add()
        {
            ...
            //  Create a new entity, set its world member variable to this,
            Entity *newEntity = new Entity();
            newEntity->world = this;
            // and insert it into the "entities" set.
        ...
        void markForRemoval(Entity *entity)
        {
            ...
            // Technically I don't think we can have more than 1 world, but just in case you never know
        ...
        void deleteMarkedEntities()
        {
            ...
            markedForRemoval.clear(); // Clear the "markedForRemoval" set after deletion
        }
        ...
        void clear()
        {
            ...
            // Delete all the entities (both marked and unmarked) and make sure that the containers are empty
