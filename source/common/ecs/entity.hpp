...
namespace our
{
    ...
    public:
        ...
        T *addComponent()
        {
            ...
            // Create an instance of the component, set its "owner" to be this entity, and push it into the components list
        ...
        T *getComponent()
        {
            ...
            //     // typedComponent will be nullptr unless it can be cast to "T*"
        ...
        T *getComponent(size_t index)
        {
            ...
            // if we advance iterator being end of components list, it will be set to components.end()
        ...
        void deleteComponent()
        {
            ...
            for (auto it = components.begin(); it != components.end(); ++it)
            {
                ...
                if (typedComponent != nullptr)
                {
                    // If found, delete the component and remove it from the components list
                    delete *typedComponent;
                    components.erase(it);
                    return; // Assuming you want to delete only the first occurrence
                }
            }
        }
        ...
        void deleteComponent(T const *component)
        {
            ...
            // Go through the components list and find the given component "component"
            for (auto it = components.begin(); it != components.end(); ++it)
            {
                // if iterator is set to the componet sent to func then delete it
                if (*it == component)
                {
                    // If found, delete the component and remove it from the components list
                    delete *it;
        ...
        ~Entity()
        {
            ...
            components.clear(); // Optional: Clear the list after deleting the components
        }
