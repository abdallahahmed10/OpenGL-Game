...
namespace our
{
    ...
    public:
        ...
        GLuint getUniformLocation(const std::string &name)
        {
            ...
            //The result of this function call is an integer that represents the location of the specified uniform variable
            // in the shader program. This location is then typically used to set the value of the uniform variable using functions like glUniform*.
        ...
        void set(const std::string &uniform, GLfloat value)
        {
            ...
            // glUniform1f: This is the OpenGL function for setting the value of a uniform variable of type float in the currently active shader program.
            // The 1f in the function name indicates that you are setting a single float value.
