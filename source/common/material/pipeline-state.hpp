...
namespace our
{
    ...
    struct PipelineState
    {
        ...
        // color mask specifies for {red,gree,blue,alpha} if we can write to them in framebuffer while drawing or not
        // depth mask does the same thing bas for depth buffer
